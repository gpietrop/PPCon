...
def train_model(train_loader, val_loader, num_epochs, path_res):
    ...
    optimizer = Adadelta(params=params, lr=lr, alpha=alpha)
    ...
    for ep in range(epoch):
        ...
        if ep % snaperiod == 0:
            ...
            with torch.no_grad():
                ...
                testing_x = torch.cat((testing_x, output_day_test, output_year_test, output_lat_test, output_lon_test),
                                      1)
