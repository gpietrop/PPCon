...
class Conv1dMed(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(in_channels, 64, kernel_size=3, stride=1, padding=2)
        ...
        self.conv12 = nn.Conv1d(128, 128, kernel_size=4, stride=1, padding=1)
        self.bn12 = nn.BatchNorm1d(128)
        self.af12 = nn.SELU()

        self.deconv13 = nn.ConvTranspose1d(128, 128, kernel_size=2, stride=2, padding=1)
        ...
        self.deconv15 = nn.ConvTranspose1d(128, 64, kernel_size=3, stride=2, padding=1)
        self.bn15 = nn.BatchNorm1d(64)
        self.af15 = nn.SELU()

        self.conv16 = nn.Conv1d(64, 32, kernel_size=2, stride=2, padding=2)
        self.bn16 = nn.BatchNorm1d(32)
        self.af16 = nn.SELU()

        self.conv17 = nn.Conv1d(32, out_channels, kernel_size=3, stride=1, padding=2)
        self.af17 = nn.SELU()
